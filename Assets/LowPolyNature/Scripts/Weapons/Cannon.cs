...
public class Cannon : InteractableItemBase
{
    ...
    private int mDamageCannonBall = 0;
    ...
    public void Shoot()
    {
        ...
        cannonball.GetComponent<Cannonball>().DamagePerHit = mDamageCannonBall;
    ...
    public override bool CanInteract(Collider other)
    {
        ...
        var damageSource = player.GetCurrentItem() as IDamageSource;
        if(damageSource != null)
        {
            mDamageCannonBall = damageSource.GetDamagePerHit();
        }
